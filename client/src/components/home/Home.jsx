  ...
  const features = [
    {
      ...
      image: "https://media.istockphoto.com/id/1572636555/vector/categories-of-healthy-eating-types-of-food-vector-illustration-on-white-background.jpg?s=612x612&w=0&k=20&c=GLvnaxS9eOtfpS_RlzyirQQ2KxEfaNyC6k6QoXt6MeY=",
    },
    {
      title: "Smart Search & Powerful Filters",
      desc: "Use our search bar and advanced filters to quickly find the perfect recipe.",
      icon: "/icons/search.svg",
      image: "https://static.vecteezy.com/system/resources/previews/004/804/322/non_2x/illustration-graphic-of-food-search-logo-perfect-to-use-for-food-company-free-vector.jpg",
    },
    {
      ...
      icon: "/icons/ai.svg",
      image: "https://img.freepik.com/premium-vector/sparkles-icon-isolated-white-background-vector-illustration_736051-308.jpg?w=360",
    },
    {
    ...
    },
    {
      ...
      image: "https://media.istockphoto.com/id/909180104/vector/vegetables-sticked-on-fork-healthy-eating-concept.jpg?s=612x612&w=0&k=20&c=nO0QH3NQm8lBa_jttyo9ht6iD_z0OeMX0zusNVWvnSE=",
    },
    {
      ...
      image: "https://previews.123rf.com/images/maximlacrim/maximlacrim2302/maximlacrim230200186/198570604-like-comment-thumbs-up-share-and-save-modern-icons-for-social-media-and-app-vector-isolated-on.jpg",
    },
    {
      ...
      image: "https://media.istockphoto.com/id/1201642586/vector/people-take-food-from-a-plate.jpg?s=612x612&w=0&k=20&c=8DL3hJgAsYTRS4vhdO6yvdH30mha8MVrEZPiXrl8UJI=",
    },
    {
      title: "Your Personal Recipe Dashboard",
      desc: "All your saved recipes, favorite dishes, and past spins—organized in one place.",
  ...
  <div className="features-wrapper">
    <div className="features-scroll">
      {features.map((feature, index) => (
        <motion.div
          key={index}
          className={`feature-card ${index % 2 !== 0 ? "reverse" : ""} theme-${index % 2 === 0 ? "dark" : "light"}`}
          initial={{ opacity: 0, y: 50 }}
      ...
      <div className="scroll-spacer">
        <a href="#next-section" className="next-section-link">
