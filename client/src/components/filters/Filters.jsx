...
const Filters = ({ onFilterChange }) => {
    ...
    const categories = ["Quick & Easy", "Healthy", "Soup", "Salad", "Pasta", "Main Course", "Appetizer", "Sweet", "Comfort Food"];
    ...
    return (
        <div className="filter-container">
            ...
            <div className="filter-section">
                <h3> <IoFastFoodSharp size={23} /> Categories</h3>
    ...
    {mealTypes.map((item) => (
      <label key={item} className="filter-option meal-type-option">
        ...
        <span>{item}</span>
            ...
            <div className="filter-section">
                <h3> <RiFilterFill size={23} /> Diet Filters</h3>
